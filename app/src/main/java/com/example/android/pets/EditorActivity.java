...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /**
     * Gender of the pet. The possible values arein the PetContract.java file:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentPetUri == null) {
            ...
            // nota cas: Initzialice el loader.
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null) {
            ...
            // was successful.
            if (newUri == null) {
                // if the new content is null, then there was an error with insertion.
            ...
            // Show a toast mesasge depending on whether or not the update was successful.
            if (rowsAffected == 0) {
                // If no rows affected, then ghere was an error with the update.
    ...
    /**
     * This method is called after invalidateOptionsMenu(), so that the menu
     * can be updated (some menu items can be hidden or made visible).
     */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                // Create a click to handle the user confirming that
    ...
    public void onBackPressed() {
        ...
        DialogInterface.OnClickListener discardButtonClickListener =
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        // User cliked "Discard" button, close the current activity.
                        finish();
                    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            String breed = cursor.getString(breedColumIndex);
            int gender = cursor.getInt(genderColumIndex);
            int weight = cursor.getInt(weightColumIndex);
